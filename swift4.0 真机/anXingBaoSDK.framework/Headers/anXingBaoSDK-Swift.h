...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="anXingBaoSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12anXingBaoSDK18DateValueFormatter")
...
SWIFT_CLASS("_TtC12anXingBaoSDK21DayAxisValueFormatter")
...
SWIFT_CLASS("_TtC12anXingBaoSDK14Heardformatter")
@interface Heardformatter : NSObject <IChartAxisValueFormatter>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
- (NSString * _Nonnull)stringForValue:(double)value axis:(ChartAxisBase * _Nullable)axis SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC12anXingBaoSDK21IntAxisValueFormatter")
...
SWIFT_CLASS("_TtC12anXingBaoSDK19LargeValueFormatter")
